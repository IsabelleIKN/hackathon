...
namespace SG
{
    ...
    public class SG_UnitySettings : ScriptableObject
    {
        ...
        /// <summary> If true, this plugin will use an alternate IPC address for the number of devices, which bypasses WebX's interference. </summary>
        [Tooltip("If true, this plugin will use an alternate IPC address for the number of devices, which bypasses WebX's interference.")]
        public bool bypassWebexIPC = false;
